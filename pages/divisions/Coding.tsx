        ...
        <div className="min-h-screen bg-[#050505] text-gray-300 font-sans selection:bg-emerald-500/30 overflow-x-hidden">
            ...
            <section className="min-h-dvh flex flex-col items-center justify-center relative px-6 py-20">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-8xl font-black tracking-tighter text-white mb-6 font-mono drop-shadow-[0_0_15px_rgba(16,185,129,0.5)]">
                        <GlitchText text="O.C. CODING" />
                    </h1>

                    <p className="text-xl md:text-3xl text-emerald-500 font-mono mb-6 tracking-[0.2em] uppercase font-bold text-shadow-sm">
            ...
            <section className="py-24 px-6 md:px-20 relative bg-[#080808] border-y border-white/5">
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="bg-[#0c0c0c] border border-white/10 rounded-xl p-8 font-mono text-sm text-gray-400 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative z-10 overflow-x-auto transform hover:-translate-y-2 transition-transform duration-500 hover:shadow-[0_20px_50px_rgba(16,185,129,0.1)]">
                            <div className="flex gap-2 mb-6 border-b border-white/10 pb-4">
                                ...
                                <div className="ml-4 text-[10px] text-gray-500 uppercase tracking-widest flex items-center">developer.ts</div>
                            </div>
            ...
            <section className="py-32 px-6 md:px-20 bg-[#080808] border-t border-white/5 relative">
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                        ...
                        >
                            VIEW IN GITHUB
                            <ArrowLeft className="rotate-135 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform rotate-[135deg]" size={16} />
                        </motion.a>
                    </div>
